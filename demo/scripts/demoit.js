...
<div class="browser" id="browser">
    ...
    showFile(index) {
        ...
        xhr.open('GET', `http://localhost:8888/sourceCode/${folder}/${files[index]}?style=vs&startLine=${startLines[index]}&endLine=${endLines[index]}`);
        xhr.send();
    }
});
...
`;
    ...
    fetchUntilSuccess(url, callback) {
        ...
        xhr.open('HEAD', `http://localhost:8888/ping?url=${url}`);
        xhr.send();
    }
});
...
<div class="browser-container">
    <iframe class="shell" scrolling="no" src="http://localhost:8888/shell/${path}"></iframe>
</div>
</div>`;
